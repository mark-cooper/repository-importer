...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/ruby-concurrency/atomic".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.post_install_message = "This gem has been deprecated and merged into Concurrent Ruby (http://concurrent-ruby.com).".freeze
